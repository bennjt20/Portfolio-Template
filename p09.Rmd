...
4) I did not like the way the numeric mediator graphs in the two graphs above. For that reason, I created a Gender variable to produce a clear, stark visual of the mediation relationship. For self-esteem scores from 0-5, I made those the Male scores, and Female scores were 6-10. 
